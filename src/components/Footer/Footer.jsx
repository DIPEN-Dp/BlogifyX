...
function Footer() {
  return (
    <footer className="w-full max-w-6xl mx-auto px-4 mb-8 mt-12 relative overflow-hidden">
      {/* Footer Container is a floating glass container */}
      <div className="glass rounded-3xl p-8 md:p-12 border border-white/10 shadow-2xl relative overflow-hidden">
        {/* Decorative backdrop glow */}
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-96 h-96 bg-purple-600/5 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10 relative z-10">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-300 mb-4">Company</h3>
            <ul className="space-y-2 text-sm">
              <li><Link to="/" className="text-slate-400 hover:text-white transition-colors">Features</Link></li>
              <li><Link to="/" className="text-slate-400 hover:text-white transition-colors">Pricing</Link></li>
              <li><Link to="/" className="text-slate-400 hover:text-white transition-colors">Affiliate Program</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/" className="text-slate-400 hover:text-white transition-colors">Customer Support</Link></li>
            </ul>
          </div>

          {/* Legal Links */}
          <div>
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-300 mb-4">Legals</h3>
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/" className="text-slate-400 hover:text-white transition-colors">Licensing</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 relative z-10">
          ...
          <div className="flex gap-4 text-xs text-slate-500">
            <Link to="/" className="hover:text-slate-300 transition-colors">Status</Link>
