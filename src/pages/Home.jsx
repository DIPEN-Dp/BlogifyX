    ...
    return (
        <div className="w-full">
            ...
            <div id="posts-section" className="py-16 border-t border-neutral-black-100 bg-neutral-black-50/30">
                <Container>
                    {!authStatus ? (
                        /* Guest: not logged in — show sign-in prompt */
                        ...
                        /* Logged in but no posts yet — show empty state */
                        <div className="text-center py-20 bg-white max-w-2xl mx-auto rounded-2xl border border-neutral-black-200 px-10 shadow-md">
                            <span className="block text-4xl mb-4">📝</span>
                            <h2 className="text-3xl font-bold font-heading text-neutral-black-950 mb-4">No Posts Yet</h2>
                            <p className="text-neutral-black-600 text-base md:text-lg mb-8">Be the first to share something with the community!</p>
                            <Link to="/add-post" className="px-8 py-3 rounded-xl font-semibold text-sm bg-brand-orange-500 hover:bg-brand-orange-600 text-white shadow-sm inline-block transition-colors duration-150">
                                Write First Post
                            </Link>
                        </div>
                    ) : (
                        /* Logged in with posts — show post grid */
                        <div>
